...
MODEL_FILE = BASE_DIR / "mlp_pipeline_umap.joblib"
PLOT_DIR = BASE_DIR
...
def main():
    global LOG_FILE
    LOG_FILE = init_run_log("mlp_umap")
    ...
    log("\nSummary metrics:")
    log(f"umap: MAE={metrics['mae']:.2f}, RMSE={metrics['rmse']:.2f}, R2={metrics['r2']:.3f}, RMSLE={metrics['rmsle']:.3f}")
